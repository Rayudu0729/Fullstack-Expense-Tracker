...
function ProfileCard({ username, email, profileImg, uploadProfileImage, removeProfileImage }) {
    ...
    return (
        <div className='profile' style={{ maxWidth: '400px', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '25px', margin: '0 auto' }}>
            <>
