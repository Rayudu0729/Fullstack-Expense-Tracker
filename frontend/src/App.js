...
const UserReports = lazy(() => import('./pages/user/reports.js'))
const AdminReports = lazy(() => import('./pages/admin/reports.js'))
...
function App() {
    ...
    const [isDarkMode, toggleTheme, themeValue] = useTheme()
